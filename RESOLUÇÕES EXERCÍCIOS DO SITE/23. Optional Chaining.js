...
console.log(getFirstKeyword(books[0])) // Saída: 'computer science'
console.log(getFirstKeyword(books[1])) // Saída: 'computer science'
console.log(getFirstKeyword(books[2])) // Saída: 'computer science'
// Se o livro não tiver a propriedade 'keywords', retornará undefined
