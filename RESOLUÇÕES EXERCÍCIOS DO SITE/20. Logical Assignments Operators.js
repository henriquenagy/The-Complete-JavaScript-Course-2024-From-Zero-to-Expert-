...
//Se não tiver a propriedade edition, então cria uma com o numero 1
for (let itens of books) {
  itens.edition ||= 1
  console.log(`The book ${itens.title} has the edition nº ${itens.edition}`)
}

/*for (let newTest of books) {
  console.log(
    (newTest.highlighted &&= !(newTest.thirdParty.goodreads.rating < 4.2))
  )
}*/
...
for (let newTest of books) {
  newTest.highlighted =
    newTest.highlighted && !(newTest.thirdParty.goodreads.rating < 4.2)
  console.log(newTest.highlighted)
}
